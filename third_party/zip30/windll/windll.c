 ...
 */
/* _NO_CRT_STDIO_INLINE is defined project-wide via CMake so every TU sees
   printf/fprintf as extern and only this file provides the bodies. */
#include <windows.h>
#include <process.h>
#include <signal.h>
#include <stdarg.h>
...
/* UCRT defines printf/fprintf/perror as inline; undef so we can override them
   to redirect to the DLL caller's print callback. */
#ifdef printf
#  undef printf
#endif
#ifdef fprintf
